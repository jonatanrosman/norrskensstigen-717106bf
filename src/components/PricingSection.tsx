...
const winterPricing = [
  ...
  { week: 12, dates: '14/3 - 21/3 2026', priceKr: '17 000 kr', priceSek: '17 000 SEK', originalPriceKr: '19 000 kr', originalPriceSek: '19 000 SEK', status: 'Ledig' },
  { week: 13, dates: '21/3 - 28/3 2026', priceKr: '17 000 kr', priceSek: '17 000 SEK', status: 'Bokad' },
  { week: 14, dates: '28/3 - 4/4 2026', priceKr: '21 500 kr', priceSek: '21 500 SEK', originalPriceKr: '23 000 kr', originalPriceSek: '23 000 SEK', status: 'Ledig' },
  { week: 15, dates: '4/4 - 11/4 2026', priceKr: '21 500 kr', priceSek: '21 500 SEK', originalPriceKr: '23 000 kr', originalPriceSek: '23 000 SEK', status: 'Ledig' },
                        ...
                        <td className="py-2 text-right">
                          {row.originalPriceKr && (
                            <div className="text-xs text-muted-foreground line-through">
                              {language === 'sv' ? row.originalPriceKr : row.originalPriceSek}
                            </div>
                          )}
